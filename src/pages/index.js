  ...
  return (
    <Layout>
      ...
      <div>
          ...
          <ul className="flex justify-center mt-8">
            ...
            <li className="w-8 ml-6 mr-6">
              <a href="https://www.stitcher.com/podcast/dog-guru">
                <img
                  src="https://s3.us-east-1.amazonaws.com/wavve-links-static/logos/stitcher.png"
                  alt="spotify"
                />
                {/* <img
          ...
          <ul className="flex justify-center mt-6">
            <li className="w-8 ml-6 mr-6">
              <a href="https://overcast.fm/itunes1294114543/ask-your-dog-guru">
                <img
                  src="https://s3.us-east-1.amazonaws.com/wavve-links-static/logos/overcast.png"
                  alt="apple"
                />
              </a>
            </li>
            ...
            <li className="w-8 ml-6 mr-6">
              ...
              <a href="https://castro.fm/itunes/1294114543">
                <img
                  src="http://supertop.co/castro/assets/listen-in-castro-icon-only.svg"
                  alt="spotify"
                />
              </a>
            </li>
            <li className="w-8 ml-6 mr-6">
              <a href="https://pca.st/private/a5969370-027f-0138-9f4b-0acc26574db2">
                <img
                  src="https://s3.us-east-1.amazonaws.com/wavve-links-static/logos/pocketcasts.png"
                  alt="spotify"
                />
              </a>
            </li>
        ...
        {/* lgx:max-w-960 lgx:p-12 lgx:text-left */}
